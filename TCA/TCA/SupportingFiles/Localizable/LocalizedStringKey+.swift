...
extension LocalizedStringKey {
    enum RocketList {
        static let title: LocalizedStringKey = "rocketList_title"

        static func firstFlight(date: Date) -> LocalizedStringKey {
            return "rocketList_firstFlight \(dateToString(date))"
        }
    }
